...
def test_user_can_create_comment(
    ...
    assert new_comment.text == '+ 1 комментарий'
...
def test_author_can_delete_own_comment(
    ...
    """Тест проверяет, что автор может удалить свой комментарий."""
...
def test_author_can_not_delete_not_own_comment(
    ...
    """Тест проверяет, что пользователь не может удалить чужой комментарий."""
    delete_url = reverse('news:delete', args=(comment.id,))
